...
public class ObjectFactory {
    ...
    private final static QName _NumberServiceException_QNAME = new QName("http://soap/", "NumberServiceException");
    private final static QName _GetNumberResponse_QNAME = new QName("http://soap/", "getNumberResponse");
    private final static QName _GetNumber_QNAME = new QName("http://soap/", "getNumber");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap/", name = "NumberServiceException")
    public JAXBElement<String> createNumberServiceException(String value) {
        return new JAXBElement<String>(_NumberServiceException_QNAME, String.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap/", name = "getNumberResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soap/", name = "getNumber")
